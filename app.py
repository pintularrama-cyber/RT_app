...
class RTOptimizerEngine:
    ...
    def get_lot_audit(self, df):
        ...
        # LOCATION LOGIC (Support for ALL)
        if self.scope == "ALL":
...
if uploaded_file:
    ...
    # Por defecto, si existe ALL lo seleccionamos
    location_scope = st.sidebar.radio("Location Scope:", options=available_scopes, index=0 if "ALL" in available_scopes else 0)
